...
import loadsData from "@/dummy data/loads.json";
...
export function LoadTable() {
  ...
  const columns = useMemo<ColumnDef<Load>[]>(() => [
    ...
    { accessorKey: "dh_o", header: "Deadhead" },
    { accessorKey: "pickup", header: "Pickup" },
    { accessorKey: "origin", header: "Origin" },
    { accessorKey: "destination", header: "Destination" },
    { accessorKey: "wt", header: "Weight" },
    { accessorKey: "size", header: "Size" },
    { accessorKey: "dist", header: "Distance" },
    ...
    <div className="w-full">
      <div className="flex items-center py-4">
        <Input
          ...
          className="max-w-sm"
          aria-label="Filter loads by origin"
        />
      ...
      <div className="rounded-md border">
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  onClick={() => setIsLoadViewOpen(true)}
                >
        ...
        <Sheet open={isLoadViewOpen} onOpenChange={setIsLoadViewOpen}>
          <SheetContent>
            <SheetHeader>
